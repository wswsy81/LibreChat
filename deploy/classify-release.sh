...
if [[ "$COUNT" -gt 0 ]]; then
  CONTROL_PATTERN='^(deploy/|scripts/|docs/|\.claude/|\.github/|test/|tests/|README($|\.)|CLAUDE\.md$|AGENTS\.md$)|^(state|decisions|specs|evals|报告|调研|library/skills)/|^projects/未来线/(scripts|specs|evals|报告|调研)/'

...
const LoginForm: React.FC<TLoginFormProps> = ({ onSubmit, startupConfig, error, setError }) => {
  ...
  const authLabelClassName =
    'absolute start-3 top-1.5 z-10 origin-[0] -translate-y-4 scale-75 transform bg-surface-primary px-2 text-sm text-text-secondary-alt duration-200 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-1.5 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-life-moss dark:peer-focus:text-emerald-400 rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4';
  ...
  return (
    <>
      {showResendLink && (
        <div className="mt-2 rounded-md border border-life-moss bg-life-moss/10 px-3 py-2 text-sm text-gray-600 dark:text-gray-200">

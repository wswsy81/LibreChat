...
export default function InboxRoute() {
  ...
  if (list.isLoading) {
    ...
    recentContent = (
      <ul>
        {items.map((entry) => (
          ...
          >
            <p className="whitespace-pre-wrap break-words font-life-kai text-[17px] leading-8 text-life-ink dark:text-gray-200">
              {entry.text}
            </p>
    ...
    recentContent = (
      <p className="border-b border-life-rule py-8 font-life-kai text-base leading-8 text-life-muted dark:border-white/10 dark:text-gray-400">
    ...
    <main className="h-full overflow-y-auto bg-life-paper text-life-ink dark:bg-surface-secondary dark:text-gray-100">
      <div className="mx-auto w-full max-w-5xl px-5 py-10 sm:px-8 lg:py-14">
        <header className="max-w-4xl border-b border-life-ink/70 pb-8 dark:border-white/30">
          ...
          <p className="mt-5 max-w-[34em] font-life-sans text-base leading-8 text-life-muted dark:text-gray-400">
        ...
        >
          ...
          <div className="min-w-0 border border-life-rule bg-[#F7F4EB] p-5 dark:border-white/10 dark:bg-surface-primary sm:p-6">
            <textarea
              ...
              className="min-h-[152px] w-full resize-y border-b border-life-rule bg-transparent pb-3 font-life-kai text-lg leading-9 text-[#3E4A40] outline-none placeholder:text-life-muted/60 focus:border-life-ink dark:border-white/15 dark:text-gray-200 dark:placeholder:text-gray-600 dark:focus:border-gray-300"
            />
            <div className="mt-4 flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Button
                ...
                disabled={!canSubmit}
                onClick={submit}
                className="min-h-11 rounded-[4px] bg-life-moss px-6 font-life-sans text-sm text-life-paper hover:bg-life-moss-deep focus-visible:ring-2 focus-visible:ring-life-moss/30 disabled:cursor-not-allowed disabled:opacity-40"
              >
            ...
            {capture.isError && (
              <p
                role="alert"
                className="mt-4 font-life-sans text-sm leading-6 text-life-cinnabar dark:text-[#D98A76]"
              >
        ...
        <aside className="grid gap-3 border-b border-life-rule py-5 dark:border-white/10 sm:grid-cols-[112px_minmax(0,1fr)] sm:gap-8">
          ...
          <p className="max-w-[34em] font-life-kai text-[15px] leading-8 text-life-brass dark:text-[#CBAA72]">
        ...
        <section className="mt-10" aria-labelledby="life-inbox-list">
          <div className="flex items-end justify-between gap-4 border-b border-life-ink/70 pb-4 dark:border-white/30">
            ...
            <span className="font-life-mono text-[10px] tabular-nums tracking-[0.16em] text-life-muted dark:text-gray-500">
              02
            </span>
          </div>
          {recentContent}

import { Home, MessageCircleMore, UserRound } from 'lucide-react';
...
export default function MobilePrimaryNav() {
  ...
  return (
    <nav
      ...
      className="grid shrink-0 grid-cols-3 border-t border-life-rule bg-life-paper pb-[env(safe-area-inset-bottom)] md:hidden"
    >
      {items.map((item) => {
        const active =
          item.href === '/c/new'

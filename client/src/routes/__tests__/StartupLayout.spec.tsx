...
function ProductEntry() {
  return <div data-testid="product-entry">Product Entry</div>;
}
...
describe('StartupLayout — redirect race condition', () => {
  ...
  it('navigates to the product entry resolver when authenticated with no pending redirect', async () => {
  ...
  it('does NOT navigate to the product entry when redirect_to URL param is present', async () => {
  ...
  it('does NOT navigate to the product entry when sessionStorage redirect is present', async () => {
    window.history.replaceState({}, '', '/login');
